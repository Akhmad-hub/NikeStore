    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between w-28 my-2">
          <div className="flex items-center bg-white/80 px-1 rounded-lg blur-effect-theme">
        ...
        <div className="flex items-center gap-3 ">
          ...
          <button
            type="button"
            className="bg-white/90 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-200 text-black"
      ...
      >
        <img
          ...
          className={` transitions-theme hover:-rotate-12 ${
            ifExists
              ? "h-auto w-64 lg:w-56 md:-w48 -rotate-[35deg]"
              : " h-36 w-64"
          }`}
        />
      </div>
