  ...
  return (
    <div className="flex items-center justify-between w-full ">
      <div className="flex items-center gap-5">
        <div
          className={`bg-gradient-to-b ${color} ${shadow} relative rounded p-3  hover:scale-110 transition-all duration-75 ease-in-out grid items-center`}
        >
          <img
            src={img}
          ...
          />
          <div className="absolute right-1 top-1 blur-theme-effect bg-white text-black text-xs px-1 rounded">
            ${price}
          </div>
        </div>
        <div className="grid items-center gap-4">
          ...
          <div className="flex items-center justify-around w-full">
            ...
            >
              <MinusIcon className="w-5 h-5 text-white lg:h-4 lg:w-4 storke-[2]" />
            </button>
            ...
            <button
              ...
              className="bg-theme-cart rounded w-6 h-6 lg:h-5 lg:w-5 flex items-center justify-center active:scale-90"
            >
              <PlusIcon className="w-5 h-5  text-white lg:h-4 lg:w-4 storke-[2]" />
            </button>
          </div>
        </div>
      </div>
      <div className="grid items-center gap-5">
        ...
        <div className="grid items-center justify-center">
          <button
            type="button"
            className="bg-theme-cart rounded p-1 grid items-center"
