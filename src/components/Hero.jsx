    ...
    <div className="relative h-auto w-auto flex flex-col ">
      ...
      <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container ">
        <div className="grid items-center justify-items-center mt-28 md:mt-24">
          ...
          <button
            type="button"
            className="button-theme shadow-md shadow-orange-300 bg-slate-200 rounded-xl mb-10 "
          >
            {btntext}
          </button>
          <div className="grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto mt-5">
            {videos.map((val, i) => (
